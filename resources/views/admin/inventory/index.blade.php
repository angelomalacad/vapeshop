...
<style>
    ...
    .dispose-modal-header h5 {
        font-size: 1rem;
        font-weight: 600;
        margin: 0;
    }

    .dispose-modal-header .btn-close {
    ...
    .dispose-modal-header .btn-close:hover {
        opacity: 1;
    }
...
@section('content')
    <div class="container-fluid px-4">
        <!-- Success and Error Messages - Hidden, converted to global notifications -->
        @if (session('success'))
            <div class="d-none" id="flashSuccess">{{ session('success') }}</div>
        @endif

        @if (session('error'))
            <div class="d-none" id="flashError">{{ session('error') }}</div>
        @endif
    ...
    <div class="modal fade" id="disposeModal" tabindex="-1" aria-labelledby="disposeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="dispose-modal-header">
                    <h5 id="disposeModalLabel">
                ...
                <form id="disposeForm" method="POST" action="">
                    ...
                    <div class="dispose-modal-footer">
                        ...
                        <button type="submit" class="btn-dispose" id="disposeSubmitBtn">
                            <i class="bi bi-trash me-2"></i> Dispose
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="archiveModal" tabindex="-1" aria-labelledby="archiveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="dispose-modal-header" style="background: #6b7280;">
                    <h5 id="archiveModalLabel">
                        <i class="bi bi-archive-fill me-2"></i>
                        Archive Item
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="archiveForm" method="GET" action="">
                    <div class="dispose-modal-body">
                    ...
                    <div class="dispose-modal-footer">
                        ...
                        <button type="submit" class="btn-dispose" id="archiveSubmitBtn" style="background: #6b7280;">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="dispose-modal-header" style="background: #10b981;">
                    <h5 id="unarchiveModalLabel">
                        <i class="bi bi-arrow-counterclockwise me-2"></i>
                        Restore from Archive
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="unarchiveForm" method="GET" action="">
                    <div class="dispose-modal-body">
                        <p>Are you sure you want to restore this archived item?</p>
                        <p class="fw-bold text-success" id="unarchiveItemName"></p>
                        <p class="text-muted small">This item will be visible in active inventory again.</p>
                    </div>
                    <div class="dispose-modal-footer">
                        <button type="button" class="btn-cancel" data-bs-dismiss="modal">
                            <i class="bi bi-x me-1"></i> Cancel
                        </button>
                        <button type="submit" class="btn-dispose" id="unarchiveSubmitBtn" style="background: #10b981;">
    ...
    <div class="modal fade" id="restoreDisposedModal" tabindex="-1" aria-labelledby="restoreDisposedModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="dispose-modal-header" style="background: #10b981;">
                    <h5 id="restoreDisposedModalLabel">
                        <i class="bi bi-arrow-counterclockwise me-2"></i>
                        Restore Disposed Item
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="restoreDisposedForm" method="GET" action="">
                    <div class="dispose-modal-body">
                        <p>Are you sure you want to restore this disposed item?</p>
                        <p class="fw-bold text-success" id="restoreDisposedItemName"></p>
                        <p class="text-muted small">This item will be restored back to active inventory.</p>
                    </div>
                    <div class="dispose-modal-footer">
                        <button type="button" class="btn-cancel" data-bs-dismiss="modal">
                            <i class="bi bi-x me-1"></i> Cancel
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const disposeItemName = document.getElementById('disposeItemName');
            const disposeSubmitBtn = document.getElementById('disposeSubmitBtn');

            if (!disposeModal) {
                console.error('Dispose modal not found!');
                return;
            }
            ...
            disposeModal.addEventListener('show.bs.modal', function(event) {
                ...
                if (disposeItemName) {
                    disposeItemName.textContent = itemName || 'Unknown Item';
                }
            ...
            if (disposeForm) {
                disposeForm.addEventListener('submit', function(e) {
                    ...
                    const submitBtn = this.querySelector('.btn-dispose');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const archiveItemName = document.getElementById('archiveItemName');
            ...
            if (archiveModal) {
                archiveModal.addEventListener('show.bs.modal', function(event) {
                    ...
                    if (archiveItemName) {
                        archiveItemName.textContent = itemName || 'Unknown Item';
                    }

                    if (archiveForm) {
                        archiveForm.action = '/admin/inventory/' + inventoryId + '/archive';
                    }
                });
            }
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const unarchiveItemName = document.getElementById('unarchiveItemName');

            if (unarchiveModal) {
                unarchiveModal.addEventListener('show.bs.modal', function(event) {
                    const button = event.relatedTarget;
                    if (!button) return;
                    ...
                    if (unarchiveItemName) {
                        unarchiveItemName.textContent = itemName || 'Unknown Item';
                    }

                    if (unarchiveForm) {
                        unarchiveForm.action = '/admin/inventory/' + inventoryId + '/unarchive';
                    }
                });
            }
        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const restoreDisposedItemName = document.getElementById('restoreDisposedItemName');
            ...
            if (restoreDisposedModal) {
                restoreDisposedModal.addEventListener('show.bs.modal', function(event) {
                    ...
                    if (restoreDisposedItemName) {
                        restoreDisposedItemName.textContent = itemName || 'Unknown Item';
                    }
