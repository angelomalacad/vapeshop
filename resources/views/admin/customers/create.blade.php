                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.customers.store') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="city" class="form-control"
                                        value="{{ old('city', 'Calamba') }}" required>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Province <span class="text-danger">*</span></label>
                                    <input type="text" name="province" class="form-control"
                                        value="{{ old('province', 'Laguna') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="barangay" class="form-control" value="{{ old('barangay') }}"
                                        placeholder="Enter barangay/district" required>
                                    <small class="text-muted">Example: Barangay San Pedro, Poblacion, etc.</small>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address" class="form-control" rows="2" placeholder="House number, street, subdivision" required>{{ old('address') }}</textarea>
                            </div>
                            ...
                            <div class="alert alert-info small">
                                ...
                                <strong>Note:</strong> New customers will receive a welcome email with their account
                                details.
                            </div>
