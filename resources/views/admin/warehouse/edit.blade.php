                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select name="flavor_id" class="form-select flavor-select-edit" data-edit-id="{{ $item->id }}" required>
...
<script>
    ...
    document.querySelectorAll('.product-select-edit').forEach(productSelect => {
        ...
        // Store current flavor ID from the original item (if any)
        ...
        if (modal) {
            modal.addEventListener('show.bs.modal', loadFlavorsForEdit);
        }
        
        // When product changes, reload flavors
        productSelect.addEventListener('change', loadFlavorsForEdit);
    });
</script>
@endsection