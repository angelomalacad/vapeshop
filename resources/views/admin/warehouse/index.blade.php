    ...
    <div class="container-fluid px-4">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-0">
                ...
                <td>{{ $item->flavor ? $item->flavor->name : 'N/A' }}
            </div>
            <td>{{ $product->category ?? 'Uncategorized' }}
        </div>
        <td>{{ $product->brand ?? 'N/A' }}
    </div>
    <td>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $item->flavor ? $item->flavor->name : 'N/A' }}" readonly>
                            </div>
                            <div class="mb-3">
                ...
                @if ($inventory->hasPages())
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end mb-0">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $inventory->previousPageUrl() }}"
                                        rel="prev">Previous</a>
                                </li>
                            @endif
                            ...
                            @if ($inventory->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $inventory->nextPageUrl() }}" rel="next">Next</a>
                                </li>
                            @else
                                <li class="page-item disabled">
