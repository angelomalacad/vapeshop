                    ...
                    <tbody>
                        @forelse($inventory as $item)
                            ...
                            <tr>
                                ...
                                <td>{{ $item->flavor ? $item->flavor->name : 'N/A' }}</div>
                                <td>{{ $product->category ?? 'Uncategorized' }}</div>
                                <td>{{ $product->brand ?? 'N/A' }}</div>
                                <td>
                            ...
                            <!-- ========== EDIT MODAL WITH EDITABLE FLAVOR ========== -->
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select name="product_id" class="form-select product-select-edit" data-edit-id="{{ $item->id }}" required>
                                                            <option value="">Select product...</option>
                                                            @foreach($products as $productOption)
                                                                <option value="{{ $productOption->id }}" {{ $item->product_id == $productOption->id ? 'selected' : '' }}>
                                                                    {{ $productOption->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select name="flavor_id" class="form-select flavor-select-edit" data-edit-id="{{ $item->id }}" data-current-flavor-id="{{ $item->flavor_id }}" required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <input type="number" step="0.01" name="last_purchase_price" class="form-control price-input" 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control total-value-display bg-primary text-white fw-bold" 
...
<!-- Add Stock Modal WITH FLAVOR SELECTOR and EXPIRATION DATE -->
...
<script>
    ...
    document.querySelectorAll('.product-select-edit').forEach(productSelect => {
        ...
        // When the modal is about to be shown, load flavors based on the current product selection
        ...
        // When product selection changes inside the modal, reload flavors
