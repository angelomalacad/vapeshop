                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="action-buttons justify-content-end">
                                        <a href="{{ route('admin.staff.edit', $member) }}" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="Edit Staff">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $member->id }}" title="Delete Staff">
            ...
            <div class="card-footer bg-white">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        @else
                            <a href="{{ $staff->previousPageUrl() }}" class="page-link border-0 text-decoration-none">
                                <i class="bi bi-chevron-left"></i> Previous
                            </a>
                        @endif
