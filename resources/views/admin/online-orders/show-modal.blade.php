    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="info-card">
                ...
                <div class="card-body-minimal">
                    <div class="timeline-container">
                        ...
                        <!-- Confirmed -->
                        <div class="timeline-item">
                            <div class="timeline-icon {{ in_array($order->order_status, ['confirmed', 'processing', 'ready', 'out_for_delivery', 'delivered']) ? 'completed' : 'pending' }}">
                                <i class="bi bi-check-circle"></i>
                            </div>
                            <div class="timeline-content">
                                <div class="timeline-title">Confirmed</div>
                                @if($order->confirmed_at)
                                    <div class="timeline-date">{{ $order->confirmed_at->format('F d, Y h:i A') }}</div>
                                @else
                        ...
                        <!-- Packing -->
                        <div class="timeline-item">
                            <div class="timeline-icon {{ in_array($order->order_status, ['processing', 'ready', 'out_for_delivery', 'delivered']) ? 'completed' : 'pending' }}">
                                <i class="bi bi-box-seam"></i>
                            </div>
                            <div class="timeline-content">
                                <div class="timeline-title">Packing</div>
                                @if($order->processing_at)
                                    <div class="timeline-date">{{ $order->processing_at->format('F d, Y h:i A') }}</div>
                                @else
                        ...
                        <!-- Ready -->
                        <div class="timeline-item">
                            <div class="timeline-icon {{ in_array($order->order_status, ['ready', 'out_for_delivery', 'delivered']) ? 'completed' : 'pending' }}">
                        ...
                        <!-- Out for Delivery -->
                        <div class="timeline-item">
                            <div class="timeline-icon {{ in_array($order->order_status, ['out_for_delivery', 'delivered']) ? 'completed' : 'pending' }}">
                                <i class="bi bi-truck"></i>
                            </div>
                            <div class="timeline-content">
                                <div class="timeline-title">Out for Delivery</div>
                                @if($order->out_for_delivery_at)
                                    <div class="timeline-date">{{ $order->out_for_delivery_at->format('F d, Y h:i A') }}</div>
                                @else
                        ...
                        <!-- Delivered -->
                        <div class="timeline-item">
                            <div class="timeline-icon {{ $order->order_status == 'delivered' ? 'completed' : 'pending' }}">
                                <i class="bi bi-flag-fill"></i>
                            </div>
                            <div class="timeline-content">
                                <div class="timeline-title">Delivered</div>
                                @if($order->delivered_at)
                                    <div class="timeline-date">{{ $order->delivered_at->format('F d, Y h:i A') }}</div>
                                @else
            ...
            <div class="alert-minimal alert-info-minimal mt-3">
                ...
                This is a <strong>read-only view</strong>. The driver and branch staff are responsible for updating the order status. You can monitor the progress here.
            </div>
        </div>
    </div>
</div>