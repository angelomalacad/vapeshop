            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="row" id="customBrandRow" style="display: {{ old('brand') == 'Other' ? 'block' : 'none' }};">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="custom_brand" class="form-control" value="{{ old('custom_brand') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="nicotine_strength" class="form-control" value="{{ old('nicotine_strength') }}" placeholder="e.g., 10mg, 20mg">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Puff Count</label>
                        <input type="number" name="puff_count" class="form-control" value="{{ old('puff_count') }}" placeholder="e.g., 10000">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Battery Capacity (mAh)</label>
                        <input type="number" name="battery_capacity" class="form-control" value="{{ old('battery_capacity') }}" placeholder="e.g., 650">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="charging_type" class="form-control" value="{{ old('charging_type') }}" placeholder="e.g., Type-C">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Liquid Capacity (ml)</label>
                        <input type="number" step="0.1" name="liquid_capacity" class="form-control" value="{{ old('liquid_capacity') }}">
                    </div>
                    <div class="col-md-4 mb-3">
