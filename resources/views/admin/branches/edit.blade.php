...
@section('title', 'Edit Branch - Vape Expo')
...
<div class="container-fluid px-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h1 class="h3 mb-1 fw-bold">Edit Branch</h1>
                <p class="text-muted mb-0">
                    <i class="bi bi-pencil me-1"></i> {{ $branch->name }}
                </p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('admin.branches.update', $branch) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $branch->phone) }}" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $branch->email) }}" required>
                        @error('email') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold">Manager Name *</label>
                        <input type="text" name="manager_name" class="form-control @error('manager_name') is-invalid @enderror" value="{{ old('manager_name', $branch->manager_name) }}" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="opening_date" class="form-control" value="{{ old('opening_date', $branch->opening_date ? \Carbon\Carbon::parse($branch->opening_date)->format('Y-m-d') : '') }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="is_active" class="form-check-input" id="is_active" value="1" {{ old('is_active', $branch->is_active) ? 'checked' : '' }}>
