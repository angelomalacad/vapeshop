                ...
                <form method="GET" action="{{ route('driver.online-orders.index') }}" class="row g-3 align-items-end">
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="lalamove_pending"
                                {{ request('status') == 'lalamove_pending' ? 'selected' : '' }}>Lalamove</option>
                        </select>
                    </div>
                    <div class="col-md-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($deliveryDateTime)
                                            ...
                                            <small
                                                class="text-muted">{{ \Carbon\Carbon::parse($deliveryDateTime)->format('h:i A') }}</small>
                                        @else
                                            <span class="text-muted">N/A</span>
                                        @endif
                                    </td>
                                            ...
                                            <div class="d-flex flex-column gap-1">
                                                ...
                                                @if ($order->delivery->delivery_proof)
                                                    <button class="btn btn-sm btn-outline-secondary w-100"
                                                        onclick="window.open('{{ Storage::url($order->delivery->delivery_proof) }}', '_blank')">
