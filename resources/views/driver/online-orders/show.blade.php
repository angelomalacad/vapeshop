...
@section('content')
    <style>
        ...
        .modal-body-custom {
            max-height: 85vh;
            overflow-y: auto;
            /* Allows vertical scrolling without a visible bar */
            padding: 0;
        }
                                    ...
                                    @foreach ($order->items as $item)
                                        @php
                                            ...
                                            if ($item->inventory && $item->inventory->branch) {
                                                ...
                                                if (
                                                    Auth::user()->branch &&
                                                    Auth::user()->branch->id == $item->inventory->branch_id
                                                ) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($fulfilledBranchName !== 'N/A')
                                                    <span
                                                        class="fulfillment-badge {{ $isAssignedBranch ? 'assigned' : 'backup' }}">
                                                        {{ $fulfilledBranchName }}
                                                    </span>
                                                @else
