            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <table class="table table-sm">
                        ...
                        <tr>
                            <th>Available:</th>
                            <td class="fw-bold {{ $inventory->available_quantity <= $inventory->low_stock_threshold ? 'text-warning' : 'text-success' }}">
                        ...
                        <tr>
                            ...
                            <td>{{ $inventory->last_restocked_at ? $inventory->last_restocked_at->format('M d, Y') : 'Never' }}</td>
                        </tr>
                    </table>
                </div>
            </div>
