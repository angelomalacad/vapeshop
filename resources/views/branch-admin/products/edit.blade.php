    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('branch-admin.products.update', $product) }}" enctype="multipart/form-data" id="editProductForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row" id="customBrandRow" style="display: {{ !in_array($product->brand, ['X-Vape', 'Slimbar', 'Relx']) ? 'block' : 'none' }};">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3" id="newCategoryRow" style="display: {{ !in_array($product->category, ['Ultra', 'Slimbar', 'Relx']) ? 'block' : 'none' }};">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="nicotine_strength" class="form-control" value="{{ $product->nicotine_strength }}" placeholder="e.g., 10mg, 20mg, 0mg">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="charging_type" class="form-control" value="{{ $product->charging_type }}" placeholder="e.g., Type-C, Micro-USB">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="form-check mt-4">
                                            <input class="form-check-input" type="checkbox" id="adjustable_airflow" name="adjustable_airflow" value="1" {{ $product->adjustable_airflow ? 'checked' : '' }}>
                                            <label class="form-check-label" for="adjustable_airflow">
                                                Adjustable Airflow
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="smart_display" name="smart_display" value="1" {{ $product->smart_display ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            @if($product->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" style="max-height: 100px;" class="img-thumbnail">
                                </div>
                            @endif
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            <input type="text" class="form-control form-control-sm" placeholder="Flavor name" id="newFlavorName">
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control form-control-sm" placeholder="Code" id="newFlavorCode">
                        </div>
                        <div class="col-md-2">
                            <button class="btn btn-sm btn-success w-100" onclick="alert('Flavor management is handled in product creation. Edit flavors by recreating the product.')">
                ...
                <div class="card-body">
                    ...
                    @if($branchInventory)
                        ...
                        <div class="mb-3">
                            ...
                            <p>{{ $branchInventory->last_restocked_at ? $branchInventory->last_restocked_at->format('M d, Y') : 'Never' }}</p>
                        </div>
                        <a href="{{ route('branch-admin.inventory.add-stock', $branchInventory) }}" class="btn btn-sm btn-success w-100">
                            <i class="bi bi-plus-circle"></i> Add Stock
                        </a>
                    @else
                        <p class="text-muted text-center py-3">This product is not in your branch inventory.</p>
                        <a href="{{ route('branch-admin.inventory.add-product') }}" class="btn btn-sm btn-primary w-100">
