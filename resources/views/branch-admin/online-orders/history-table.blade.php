...
<div class="container-fluid">
        ...
        <form method="GET" action="{{ route('branch-admin.pos.history') }}"
            ...
            <div class="col-md-4">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('branch-admin.pos.history', ['tab' => 'online']) }}" class="btn-reset">
        ...
        <div class="col">
            <div class="card status-card">
                <div class="card-body text-center py-2">
                    ...
                    <h6 class="status-number mb-0">{{ $onlinePending ?? 0 }}</h6>
        ...
        <div class="col">
            <div class="card status-card">
                <div class="card-body text-center py-2">
                    ...
                    <h6 class="status-number mb-0">{{ $onlineConfirmed ?? 0 }}</h6>
        ...
        <div class="col">
            <div class="card status-card">
                <div class="card-body text-center py-2">
                    ...
                    <h6 class="status-number mb-0">{{ $onlineProcessing ?? 0 }}</h6>
        ...
        <div class="col">
            <div class="card status-card">
                <div class="card-body text-center py-2">
                    ...
                    <h6 class="status-number mb-0">{{ $onlineReady ?? 0 }}</h6>
        ...
        <div class="col">
            <div class="card status-card">
                <div class="card-body text-center py-2">
                    ...
                    <h6 class="status-number mb-0">{{ $onlinePickedUp ?? 0 }}</h6>
        ...
        <div class="col">
            <div class="card status-card">
                <div class="card-body text-center py-2">
                    ...
                    <h6 class="status-number mb-0">{{ $onlineOutForDelivery ?? 0 }}</h6>
        ...
        <div class="col">
            <div class="card status-card">
                <div class="card-body text-center py-2">
                    ...
                    <h6 class="status-number mb-0">{{ $onlineDelivered ?? 0 }}</h6>
    ...
    <div class="card modern-card">
        <div class="card-header-modern d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <span class="badge bg-secondary">Total: {{ $onlineOrders->total() }} orders</span>
        </div>
                    ...
                    <tbody>
                        @forelse($onlineOrders as $order)
                            ...
                            <tr>
                                ...
                                <td class="pe-4">
                                    <button onclick="openBranchOrderModal({{ $order->id }})"
        ...
        @if ($onlineOrders->hasPages())
            <div class="card-footer bg-white border-0 py-3">
                <div class="d-flex justify-content-center">
                    {{ $onlineOrders->appends(['tab' => 'online'])->links() }}
                </div>
            </div>
        @endif
    </div>
...
<!-- Modal Container -->
<div id="branchOrderModalContainer"></div>

<script>
    function openBranchOrderModal(orderId) {
        const container = document.getElementById('branchOrderModalContainer');
        container.innerHTML = '';
        ...
        const modalHtml = `
        <div class="modal fade" id="branchOrderModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true">
    ...
    `;
        ...
        const modalElement = document.getElementById('branchOrderModal');
        const modal = new bootstrap.Modal(modalElement);
        modal.show();

        fetch(`/branch-admin/online-orders/${orderId}/modal`)
            .then(response => response.text())
            .then(html => {
                const modalContent = document.querySelector('#branchOrderModal .modal-content');
                if (modalContent) {
